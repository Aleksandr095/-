Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=128776.540056703zzcDQtDpcHQVzzzHDQHtDpzfQzHf", ENDITEM, 
	...
	lr_start_transaction("Pfgjkytybt gjktq");
	...
	web_submit_data("reservations.pl", 
		...
		"Name=departDate", "Value=05/18/2020", ENDITEM, 
		"Name=arrive", "Value=Los Angeles", ENDITEM, 
		"Name=returnDate", "Value=05/19/2020", ENDITEM, 
	...
	lr_end_transaction("Pfgjkytybt gjktq",LR_AUTO);
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=031;224;05/18/2020", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Coach", ENDITEM, 
		"Name=seatPref", "Value=None", ENDITEM, 
